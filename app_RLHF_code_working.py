...
# 3.3: APPLY FEEDBACK TO DOCS --- RLHF-lite: Feedback score updater ---
...
def retriever(state: AgentState) -> AgentState:
    ...
    try:
        ...
        # Remove empty or whitespace-only context strings
        contexts = [c for c in contexts if c and c.strip()]
        contexts = contexts[:5]  # Only keep top 5 context chunks
